              ...
              <div class="page-wrapper">
                <div class="blog-title-area text-center">
                  <ol class="breadcrumb hidden-xs-down">
                    ...
                    <li class="breadcrumb-item active">
                      Why we moved from Angular 2 to Vue.js (and why we didn’t
                      choose React)
                    </li>
                  </ol>

                  <span class="color-orange"
                    ><a href="tech-category-01.html" title="">Vue.js</a></span
                  >
                ...
                <div class="blog-content">
                  <div class="pp">
                    ...
                    <h3>
                      <strong
                        ...
                        amet, consectetur adipiscing elit.</strong
                      >
                    </h3>
                  ...
                  <div class="pp">
                    <h3>
                      <strong
                        >Nam non velit est. Sed lobortis arcu vitae nunc
                        molestie consectetur. Nam eget neque ac ex fringilla
                    ...
                    <div class="col-lg-6">
                      <div class="blog-box">
                        ...
                        <div class="blog-meta">
                          <h4>
                            <a href="tech-single.html" title=""
                              >We are guests of ABC Design Studio</a
                            >
                          </h4>
                          <small
                    ...
                    <div class="col-lg-6">
                      <div class="blog-box">
                        ...
                        <div class="blog-meta">
                          <h4>
                            <a href="tech-single.html" title=""
                              >Nostalgia at work with family</a
                            >
                          </h4>
                          <small
                            ><a href="blog-category-01.html" title=""
                    ...
                    <div class="list-group">
                      ...
                      >
                        <div class="w-100 justify-content-between">
                          ...
                          />
                          <h5 class="mb-1">5 skills you need..</h5>
                      ...
                      >
                        <div class="w-100 last-item justify-content-between">
                          <img
                            ...
                            class="img-fluid float-left"
                          />
                          <h5 class="mb-1">Did you see the most rated..</h5>
